        ...
        val Saver: Saver<BarChartState, *> = listSaver(
            save = { state ->
                listOf(
                    ...
                    state.description,
                    state.touchEnabled,
                    state.isHighlightFullBarEnabled,
                    state.isDrawValueAboveBarEnabled,
                    state.isDrawBarShadowEnabled
                )
            },
            restore = { list ->
                BarChartState().apply {
                    ...
                    description = list[1] as String?
                    touchEnabled = list[2] as Boolean
                    isHighlightFullBarEnabled = list[3] as Boolean
                    isDrawValueAboveBarEnabled = list[4] as Boolean
                    isDrawBarShadowEnabled = list[5] as Boolean
                }
            }
        )
    }
