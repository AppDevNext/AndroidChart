...
import com.github.mikephil.charting.utils.Utils.metrics
...
object Utils {
     ...
     * @return
     */
    fun nextUp(d: kotlin.Double): kotlin.Double {
        var d = d
        if (d == kotlin.Double.POSITIVE_INFINITY) {
            return d
        } else {
            d += 0.0
    ...
    fun drawMultilineText(
        canvas: Canvas, textLayout: StaticLayout,
    ...
    fun drawMultilineText(
        ...
        drawMultilineText(canvas, textLayout, x, y, paint, anchor, angleDegrees)
    }
     ...
     * @return A Recyclable FSize instance
     */
    fun getSizeOfRotatedRectangleByDegrees(rectangleSize: FSize, degrees: kotlin.Float): FSize {
     ...
     * @return A Recyclable FSize instance
     */
    fun getSizeOfRotatedRectangleByRadians(rectangleSize: FSize, radians: kotlin.Float): FSize {
        return getSizeOfRotatedRectangleByRadians(
            rectangleSize.width, rectangleSize.height,
            radians
        )
 ...
 */
fun kotlin.Float.convertPixelsToDp(): kotlin.Float {
    if (metrics == null) {
        Log.e(
            "chartLib-Utils",
 ...
 */
fun MutableList<String?>.convertStrings(): Array<String?> {
    val ret = arrayOfNulls<String>(this.size)
 ...
 */
@JvmOverloads
fun kotlin.Float.formatNumber(
    digitCount: Int, separateThousands: Boolean,
    separateChar: Char = '.'
): String {
    var number = this
