...
open class HorizontalBarChartRenderer(
    ...
    override fun prepareBarHighlight(x: Float, y1: Float, y2: Float, barWidthHalf: Float, trans: Transformer) {
        ...
        trans.rectToPixelPhaseHorizontal(barRect, mAnimator.phaseY)
    }
