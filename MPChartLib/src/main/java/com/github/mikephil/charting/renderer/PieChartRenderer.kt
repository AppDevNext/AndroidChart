...
open class PieChartRenderer(
     ...
     */
    protected var mRoundedCornerPaint: Paint
    ...
    var roundedCornerRadius: Float
         ...
         */
        get() = mRoundedCornerPaint.strokeWidth
        /**
         * Setter for the rounded corner slice paint object
         */
        set(radius) {
            mRoundedCornerPaint.strokeWidth = radius
        }
    ...
    protected fun drawDataSet(c: Canvas?, dataSet: IPieDataSet) {
        ...
        if (roundedCornerRadius > 0) {
            mRoundedCornerPaint.strokeCap = Paint.Cap.ROUND
            mRoundedCornerPaint.strokeJoin = Paint.Join.ROUND
        }
        ...
        for (j in 0..<entryCount) {
            ...
            mRoundedCornerPaint.color = dataSet.getColor(j)
    ...
    override fun drawValues(c: Canvas) {
        ...
        for (i in dataSets.indices) {
            ...
            for (j in 0..<entryCount) {
                ...
                val value = if (mChart.isUsePercentValuesEnabled) (entry.y
                ...
                if (drawXOutside || drawYOutside) {
                    ...
                    val line1Radius = if (mChart.isDrawHoleEnabled) ((radius - (radius * holeRadiusPercent))
    ...
    protected fun drawCenterText(c: Canvas) {
        ...
        if (mChart.isDrawCenterTextEnabled && centerText != null) {
            ...
            val innerRadius = if (mChart.isDrawHoleEnabled && !mChart.isDrawSlicesUnderHoleEnabled)
    ...
    init {
        ...
        mRoundedCornerPaint = Paint(Paint.ANTI_ALIAS_FLAG)
        mRoundedCornerPaint.style = Paint.Style.STROKE
        mRoundedCornerPaint.isAntiAlias = true
    }
    ...
    protected fun drawRoundedSlices(c: Canvas?) {
        ...
        for (j in 0..<dataSet.entryCount) {
            ...
            if ((abs(e.y.toDouble()) > Utils.FLOAT_EPSILON)) {
                ...
                paintRender.color = dataSet.getColor(j)
                mBitmapCanvas!!.drawCircle(x, y, circleRadius, paintRender)
            }
