    ...
    fun renderLegend(c: Canvas) {
        ...
        when (horizontalAlignment) {
            ...
            LegendHorizontalAlignment.RIGHT -> {
                ...
                if (direction == LegendDirection.LEFT_TO_RIGHT) originPosX -= legend.mNeededWidth
            }

            LegendHorizontalAlignment.CENTER -> {
                originPosX = if (orientation == LegendOrientation.VERTICAL) viewPortHandler.chartWidth / 2f
