...
abstract class AxisBase : ComponentBase() {
    ...
    var valueFormatter: IAxisValueFormatter
        get() {
            ...
            return mAxisValueFormatter ?: DefaultAxisValueFormatter(mDecimals)
        }
        /**
         ...
         * that are drawn inside the chart. Use chart.getDefaultValueFormatter() to use the formatter calculated by the chart.
         */
        set(formatter) {
